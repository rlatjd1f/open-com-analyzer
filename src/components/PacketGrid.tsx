...
const PacketRow: React.FC<PacketRowProps> = memo(({
  pkt,
  rxDisplayMode,
  txDisplayMode,
  themeName,
...
export const PacketGrid: React.FC<PacketGridProps> = ({
  ...
  const handleLeaveByte = useCallback(() => {
    setHoveredByte(null);
  }, []);
  ...
  return (
    <div
      style={
        {
          '--rx-color': theme.rxColor,
          '--tx-color': theme.txColor,
          '--text-color': theme.textColor
        } as React.CSSProperties
      }
      className="relative flex-1 flex flex-col h-full overflow-hidden w-full"
    >
